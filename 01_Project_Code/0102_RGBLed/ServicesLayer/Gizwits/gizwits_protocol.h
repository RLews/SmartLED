...
* @{
*/
#define PRODUCT_KEY "a8fcd7c7b31e4f94be2d4e4af259a2f3"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "e487c834da044da9a185fcbdbfb3b281"
...
* @{
*/
#define Led_WarmSta_BYTEOFFSET                    0
#define Led_WarmSta_BITOFFSET                     0
#define Led_WarmSta_LEN                           1
#define LedOnOff_BYTEOFFSET                    0
#define LedOnOff_BITOFFSET                     1
#define LedOnOff_LEN                           1

#define Led_RVal_RATIO                         1
#define Led_RVal_ADDITION                      0
#define Led_RVal_MIN                           0
#define Led_RVal_MAX                           255
#define Led_GVal_RATIO                         1
#define Led_GVal_ADDITION                      0
#define Led_GVal_MIN                           0
#define Led_GVal_MAX                           255
#define Led_BVal_RATIO                         1
#define Led_BVal_ADDITION                      0
#define Led_BVal_MIN                           0
#define Led_BVal_MAX                           255
#define Led_Brightness_RATIO                         1
#define Led_Brightness_ADDITION                      0
#define Led_Brightness_MIN                           0
#define Led_Brightness_MAX                           4095
/**@} */
...
typedef struct {
  bool valueLed_WarmSta;
  bool valueLedOnOff;
  uint32_t valueLed_RVal;
  uint32_t valueLed_GVal;
  uint32_t valueLed_BVal;
  uint32_t valueLed_Brightness;
} dataPoint_t;


/** Corresponding to the protocol "4.10 WiFi module control device" in the flag " attr_flags" */ 
typedef struct {
  uint8_t flagLed_WarmSta:1;
  uint8_t flagLedOnOff:1;
  uint8_t flagLed_RVal:1;
  uint8_t flagLed_GVal:1;
  uint8_t flagLed_BVal:1;
  uint8_t flagLed_Brightness:1;
} attrFlags_t;
...
typedef struct {
  ...
  uint8_t valueLed_RVal;
  uint8_t valueLed_GVal;
  uint8_t valueLed_BVal;
  uint16_t valueLed_Brightness;
} attrVals_t;
