...
typedef enum {
    GIZ_LOG_TYPE_DEBUG = 0,
    GIZ_LOG_TYPE_ERROR = 1,
    GIZ_LOG_TYPE_BIZ = 2
} GIZ_LOG_TYPE;
 ...
 *
 */
#define GIZ_LOG_BIZ(businessCode, result, fmt, args...)  GizPrint(GIZ_LOG_TYPE_BIZ, "[APPBIZ][%s][%s][%s][" fmt"]", GizTimeStr(), businessCode, result, ##args)
 ...
 *
 */
#define GIZ_LOG_ERROR(fmt, args...)  GizPrint(GIZ_LOG_TYPE_ERROR, "[APPSYS][ERROR][%s][%s:%d %s][" fmt"]", GizTimeStr(), __FILENAME__, __LINE__, __FUNCTION__, ##args)
 ...
 *
 */
#define GIZ_LOG_DEBUG(fmt, args...)  GizPrint(GIZ_LOG_TYPE_DEBUG, "[APPSYS][DEBUG][%s][%s:%d %s][" fmt"]", GizTimeStr(), __FILENAME__, __LINE__, __FUNCTION__, ##args)
...
void GizPrint(GIZ_LOG_TYPE type, const char *format, ...);
