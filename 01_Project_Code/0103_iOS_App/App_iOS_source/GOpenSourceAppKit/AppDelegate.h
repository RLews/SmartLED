...
#define FACEBOOK_APP_ID [GosCommon sharedInstance].facebookAppID

#define TWITTER_APP_ID [GosCommon sharedInstance].twitterAppID
#define TWITTER_APP_SECRET [GosCommon sharedInstance].twitterAppSecret
