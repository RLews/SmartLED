/*
************************************************************************************************************************
* file : E:\KeilWorkspace\M3\uCOS_III_mdk5\ServicesLayer\osal\inc\osal.h
* Description : 
* Owner : Lews Hammond
* Time : 2019-6-4
************************************************************************************************************************
...
#else
#define D_OSAL_ALLOC_CRITICAL_SR()	
#define D_OSAL_ENTER_CRITICAL()		Hal_DisableAllInt()
#define D_OSAL_EXIT_CRITICAL()		Hal_EnableAllInt()
#endif
...
typedef enum _FS_DIR_ANAY_STA_T
{
	EN_DIR_ANAYSIS_OK = 0,
	EN_DIR_NO_EXIST,
	EN_DIR_PARAMTER_ERR
